        ...
        <div class="collapse navbar-collapse flex-grow-1" id="navbarNav">
          <div class="d-flex flex-column flex-lg-row align-items-lg-center w-100">
            ...
            <div class="dropdown me-lg-4 mb-3 mb-lg-0">
              <a class="btn btn-black rounded-pill px-4 py-2 d-flex align-items-center btn-header {{ Request::is('catalog') ? 'active' : '' }}" href="#" id="catalogDropdown" role="button">
                Каталог
              ...
              <ul class="dropdown-menu catalog-mega-menu" aria-labelledby="catalogDropdown">
                ...
                <li class="mega-menu-header">
                  <a class="dropdown-item d-flex align-items-center mega-menu-all" href="{{ route('catalog.categories') }}">
                ...
                <div class="mega-menu-content">
                  <div class="row">
                    ...
                    @foreach($mainCategoriesWithSpecs as $category)
                      <div class="{{ $colClass }} mb-3">
                          <div class="mega-category">
                              <a class="mega-category-title" href="{{ route('catalog.category', $category->id) }}">
                                  @php
                              ...
                              @if (!empty($category->filters['brand'])) {{-- Убедимся, что фильтр по бренду существует --}}
                                  <ul class="mega-category-list list-unstyled">
                                      ...
                                      @foreach($displayValues as $value)
                                          @if ($value === 'ARDOR')
                                              @continue {{-- Пропускаем бренд ARDOR, если он попал сюда (хотя фильтр выше должен его обработать) --}}
                                          @endif
                                          <li>
                                              <a class="mega-subcategory-item" href="{{ route('catalog.category', $category->id) }}?filter[brand][]={{ urlencode($value) }}">
                                                  {{ $value }}
                                              </a>
                                          </li>
                                          @php $count++; @endphp
            ...
            <div class="d-flex flex-column flex-lg-row gap-4 me-lg-4 mb-3 mb-lg-0">
              ...
              <a href="{{ route('shops') }}" class="text-dark text-decoration-none {{ Request::is('shops') ? 'active' : '' }}">Новости</a>
              <a href="{{ route('promotions') }}" class="text-dark text-decoration-none {{ Request::is('promotions') ? 'active' : '' }}">О компании</a>
            </div>
